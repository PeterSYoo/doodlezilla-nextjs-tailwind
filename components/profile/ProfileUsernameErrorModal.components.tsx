        ...
        <div className="container mx-auto w-11/12 md:w-8/12 lg:max-w-[600px]">
          <div className="relative py-14 bg-white dark:bg-midnight rounded-3xl flex flex-col gap-10 items-center">
            ...
            <div className="flex justify-center w-full">
              ...
              <button
                onClick={() => setIsUsernameErrorModal(false)}
                className="py-2 px-20 flex items-center justify-center gap-3 rounded-full bg-gradient-to-t from-[#5755D3] to-cobalt text-white font-semibold transition duration-300 ease-in-out hover:animate-button hover:bg-[length:400%_400%] hover:from-[#F97E1C] hover:via-sunset hover:to-[#5755D3] dark:hover:border-transparent"
              >
